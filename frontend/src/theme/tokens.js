/**
 * Design Tokens
 * Core design system values for the meal prediction application
 * Based on the purple theme reference with modern, professional aesthetics
 */

export const designTokens = {
  // Color System - Purple-centric with restrained palette
  colors: {
